...
public interface RegexForm {
    ...
    String REGEX_HOME_NUMBER_UA = "[0-9_-А-ЩЬЮЯҐІЇЄ]{1,500}$";
    String REGEX_HOME_NUMBER_EN = "[0-9_-A-Z]{1,500}$";
    String REGEX_ROOM_NUMBER_UA = "[0-9_-А-ЩЬЮЯҐІЇЄ]{1,500}$";
    String REGEX_ROOM_NUMBER_EN = "[0-9_-A-Z]{1,500}$";
